const niches = [
    { name: 'E-commerce', icon: '🛍️️' },
    { name: 'Portfolio', icon: '📁️️' },
    { name: 'Blog', icon: '✍️️' },
    { name: 'Corporate', icon: '🏢️️' },
    { name: 'Non-Profit', icon: '🤝️️' },
    { name: 'Educational', icon: '📖️️' },
    { name: 'Health & Fitness', icon: '🏃️️' },
    { name: 'Travel', icon: '✈️️' },
    { name: 'Restaurant', icon: '🍴️️' },
    { name: 'Photography', icon: '📸️️' },
    { name: 'Real Estate', icon: '🏠️️' },
    { name: 'Technology', icon: '📱️️' },
    { name: 'Entertainment', icon: '🎭️️' },
    { name: 'Fashion', icon: '👔️️' },
    { name: 'Sports', icon: '⚽️️' },
    { name: 'Music', icon: '🎵️️' },
    { name: 'Art & Design', icon: '🎨️️' },
    { name: 'Finance', icon: '💵️️' },
    { name: 'Automotive', icon: '🚗️️' },
    { name: 'Web3', icon: '🔗️️' },
    { name: 'News', icon: '📰️️' },
    { name: 'Gaming', icon: '🎲️️' },
    { name: 'Pet Services', icon: '🐕️️' },
    { name: 'Personal Blog', icon: '📝️️' },
    { name: 'Beauty', icon: '💄️️' },
    { name: 'Wedding', icon: '💍️️' },
    { name: 'Events', icon: '🎪️️' }
];
